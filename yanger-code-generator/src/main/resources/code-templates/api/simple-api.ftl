...
public class ${modelName}${apiSuffixName} {
     ...
     */
    @PostMapping
    public void save(@RequestBody ${saveObjName} ${saveObjName?uncap_first}) {
     ...
     */
    @PostMapping("list")
    public void saveList(@RequestBody List <${saveObjName}> ${saveObjName?uncap_first}s) {
		<#if (acp.saveListCp)??>
        ${acp.saveListCp}
		</#if>
     ...
     */
    @DeleteMapping("list")
    public void removeList(@RequestBody List <Long> ids) {
     ...
     */
    @PutMapping
    public void update(@RequestBody ${saveObjName} ${saveObjName?uncap_first}) {
        <#if (acp.saveOrUpdateCp)??>
        ${acp.saveOrUpdateCp}
        </#if>
     ...
     */
    @GetMapping("{id}")
    public ${retObjName} find(@PathVariable Long id) {
