...
public final class ConfigKey {
    ...
    /** xss 配置项 web-spring-boot-starter/src/main/java/com/yanger/starter/web/property/XssProperties.java */
    ...
    /** json 配置项 base-spring-boot-starter/src/main/java/com/yanger/starter/basic/property/JsonProperties.java */
    ...
    /** token 配置项 web-spring-boot-starter/src/main/java/com/yanger/starter/web/property/TokenProperties.java */
    public static class TokenConfigKey {

        /** 是否开启token验证，默认开启 */
        public static final String TOKEN_ENABLE = "yanger.token.enable";
    ...
    /** 微信授权配置项 web-spring-boot-starter/src/main/java/com/yanger/starter/web/wx/property/WxMaProperties.java */
    ...
    /** mybatis配置项 mybatis-spring-boot-starter/src/main/java/com/yanger/starter/mybatis/property/MybatisProperties.java */
    ...
    /** id生成 配置项 id-spring-boot-starter/src/main/java/com/yanger/starter/id/property/IdProperties.java */
    ...
    /** log日志 配置项 log-spring-boot-starter/src/main/java/com/yanger/starter/log/property/LogbackProperties.java */
    ...
    /** mongo 配置 yanger-spring-boot-starter/mongo-spring-boot-starter/src/main/java/com/yanger/starter/mongo/property/MongoProperties.java */
    ...
    /** SerializeEnumContainer 配置 yanger-spring-boot-starter/web-spring-boot-starter/src/main/java/com/yanger/starter/web/property/EnumProperties.java */
    public static class EnumConfigKey {
