...
/**
 * String 转 Date 的转化器, 适用于 controller 基础字段转换 (非实体), 实体由 Jackson 进行转换
 * @Author yanger
...
public class StringToDateConverter implements Converter<String, Date> {
    ...
    public Date convert(@NotNull String source) {
        return DateFormat.parse(source, System.getProperty(ConfigKey.JsonConfigKey.JSON_DATE_FORMAT, PATTERN));
    }
}
