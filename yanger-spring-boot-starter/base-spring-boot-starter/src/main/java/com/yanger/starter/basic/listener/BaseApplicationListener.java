 ...
 */
public interface BaseApplicationListener extends GenericApplicationListener {
     ...
     * @return the string
     */
    default String key(@NotNull ApplicationEvent event, @NotNull Class<? extends BaseApplicationListener> subClass) {
