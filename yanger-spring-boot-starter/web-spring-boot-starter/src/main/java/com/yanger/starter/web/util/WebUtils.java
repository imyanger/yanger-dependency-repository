...
public class WebUtils extends org.springframework.web.util.WebUtils {
     ...
     */
    public static @NotNull
    String getUrl(@NotNull HttpServletRequest request) {
    ...
    public static String getRequestStr(@NotNull HttpServletRequest request, byte[] buffer) {
        ...
        if (StringUtils.isBlank(str)) {
            ...
            while (parameterNames.hasMoreElements()) {
                ...
                StringTools.appendBuilder(sb, key, StringPool.EQUALS, value, StringPool.AMPERSAND);
            }
            str = StringTools.removeSuffix(sb.toString(), StringPool.AMPERSAND);
        }
     ...
     */
    public static @NotNull
    Map<String, String> getHeader(@NotNull HttpServletRequest request) {
        // 获取所有的消息头名称
     ...
     */
    public static @NotNull
    Map<String, Object> buildQueryParamsMap(@NotNull HttpServletRequest request) {
        ContentCachingRequestWrapper cachingRequestWrapper = new ContentCachingRequestWrapper(request);
     ...
     */
    private @NotNull
    Map<String, String> getTypesafeRequestMap(@NotNull HttpServletRequest request) {
        ContentCachingRequestWrapper cachingRequestWrapper = new ContentCachingRequestWrapper(request);
    ...
    public static String getBody(@NotNull HttpServletRequest request) {
        ...
        return StringTools.replaceBlank(bodyInfo);
    }
    ...
    Map<String, String> getUrlParams(String param) {
        ...
        if (param.startsWith(StringPool.QUESTION_MARK)) {
            param = StringTools.subAfter(param, StringPool.QUESTION_MARK);
        }
    ...
    public static String getUrlParamsByMap(Map<String, String> map) {
        ...
        if (s.endsWith(StringPool.AMPERSAND)) {
            s = StringTools.subBefore(s, StringPool.AMPERSAND);
        }
        return s;
    }
