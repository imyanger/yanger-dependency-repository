package com.yanger.starter.dubbo.spi;
...
/**
 * @Description 通过 SPI 加载 dubbo 默认配置
 * @Author yanger
...
public class DubboLauncherInitiation implements LauncherInitiation {
    ...
    public Map<String, Object> launcher(Environment env, String appName) {
        ...
        // TODO nacos地址和命名空间
        // chainMap.put(ConfigKey.DubboConfigKey.METADATA_REPORT_ADDRESS, "nacos://" + ConfigDefaultValue.NACOS_SERVER + "?namespace=" +
        // App.NAME_SPACE);
        ...
        // 如果存在 START_FAKH_APPLICATION 环境变量, 则表示使用了 fakh-launcher 依赖
        Object port = 20880;
        // TODO 端口问题
        // if (StringUtils.isNotBlank(System.getProperty(App.START_FAKH_APPLICATION)) && !ConfigKit.isStartedByJunit()) {
    ...
    public String getName() {
        return "dubbo-spring-boot-starter:DubboLauncherInitiation";
    }
