...
import com.fkhwl.starter.basic.annotation.SerializeValue;
import com.fkhwl.starter.common.enums.SerializeEnum;
import com.fkhwl.starter.common.enums.serialize.EntityEnumDeserializer;
import com.fkhwl.starter.common.enums.serialize.EntityEnumSerializer;
...
public class GeneralEnumTypeHandler<E extends Enum<?>> extends BaseTypeHandler<Enum<?>> {
    ...
    public GeneralEnumTypeHandler(Class<E> type) {
        ...
        // 是 SerializeEnum 子类, 则使用 com.fkhwl.starter.common.enums.SerializeEnum.getValue
